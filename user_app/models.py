...
class HavayiCashBack(models.Model):
    cash_back = models.FloatField(validators=[MinValueValidator(0.0), MaxValueValidator(100000)], default=0.0,
                                  null=True, blank=True)

    def __str__(self):
        return f'{self.cash_back}'
...
class MyUser(AbstractUser):
    ...
    MY_USER_ID = models.CharField(max_length=255,null=True,blank=True,default='0')
